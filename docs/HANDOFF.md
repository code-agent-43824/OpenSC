...
- Приоритет конфигурации рядом с spy-модулем, fallback, шаблон и тест
  реализованы; локальный Linux x64 test kit прошел. Текущий шаг — полный CI и
  выпуск `0.27.1-portable.4`.
